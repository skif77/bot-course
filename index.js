...
const token = '6510579156:AAFPUQgFn9YSUPrrILuYp2G2aqCUuwo8uR8'
...
const start = async () => {
    ...
    bot.setMyCommands([
        ...
        {command: '/anycomand', description: 'Любая команда'},
    ])
    ...
    bot.on('message', async msg => {
        ...
        try {
            ...
            if (text === '/anycomand') {
               await bot.sendSticker(chatId,'https://tlgrm.ru/_/stickers/ea5/382/ea53826d-c192-376a-b766-e5abc535f1c9/7.webp' )
               return bot.sendMessage(chatId, `Добро пожаловать! Выполнили любую команду в ${chatId} `)
